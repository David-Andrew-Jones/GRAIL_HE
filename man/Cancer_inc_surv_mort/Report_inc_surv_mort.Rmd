---
title: "Trends in cancer incidence, morality and survival"
output: 
 html_document:
   theme: united # default, cerulean, journal, flatly, darkly, readable, spacelab, united, cosmo, lumen, paper, sandstone, simplex, and yeti
...
Data presented below has been extracted from CancerData’s incidence and mortality [dashboard](https://www.cancerdata.nhs.uk/incidence_and_mortality), and survival [dashboard](). For incidence and mortality this data spans from 2001 to 2020 and is taken from the National Cancer Registration Service Cancer Analysis System (CAS).
